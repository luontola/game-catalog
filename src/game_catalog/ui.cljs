...
(def sample-collections
  {:games {:documents {#uuid "e5da0728-35f3-4330-9432-9199142166ef" {:name "Amnesia: Rebirth"
                                                                     :release 2020
                                                                     :series "Amnesia"
                       ...
                       #uuid "f96d974f-50de-431c-bc27-976ecc1d0bb3" {:name "Satisfactory"
                                                                     :purchases [#uuid "a94b179d-d41d-48bc-b874-5e2f1019e61a"]
                                                                     :status "Backlog"}}}
   :purchases {:documents {#uuid "7d201baf-7a4d-49eb-8dd1-4bfd9920320e" {:date "2017-06-07"
                                                                         :cost "0 EUR"
